...
def init_parser(default_dataset='UFSR', default_data_dir=None, default_exp_dir=None):
    repo_root = Path(__file__).resolve().parents[2]
    default_data_dir = default_data_dir or os.path.join(str(repo_root / 'data'), '')
    default_exp_dir = default_exp_dir or os.path.join(str(repo_root / 'data' / 'exp_dir'), '')
    default_pose_abnormal = os.path.join(str(repo_root / 'data' / default_dataset / 'pose' / 'abnormal_train'), '')
